...
**************/
(function(){
var OpenVer="2022.230423.230604",OpenDate="2023-06-04";
...
var CsvPubDate=window.CsvPubDate={
	...
	,Geo:{
		name:"省市区三级坐标边界数据"
		,desc:'['+Url("下载",UrlRoot+"assets/download.html")+']['+Url("在线预览",UrlEcharts)+'][<span style="color:#0a0">免费开源</span>] 文件大小：13MB+压缩包，解压后130M+；包含字段：矢量边界polygon、城市中心坐标geo、城市id、城市pid、城市名称name；'+GeoTips+'。本数据源自：高德地图开放平台，通过开放接口获取。'
		,file:"ok_geo.csv"
		,version:OpenVer
		,date:OpenDate
	}
...
内蒙古:"2018",						  辽宁:"2021-12 A2021-11",
  ...
  浙江:"2022-11",					  安徽:"2018",
  福建:"2021-12",					  江西:"2019-07",
  山东:"2020-09",					  河南:"2020-01",
  湖北:"2018",						  湖南:"2019-07",
  广东:"2018",						  广西:"2018",
  海南:"2018",						  重庆:"2018",
  四川:"2018",						  贵州:"2018-08",
